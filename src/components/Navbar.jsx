...
import { FaBars, FaTimes, FaGithub, FaGitlab } from 'react-icons/fa';
    ...
    <div className='fixed w-full h-[80px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300 shadow-md'>
      ...
      <div className='hidden lg:flex fixed flex-col top-[35%] left-0'>
        <ul>
          ...
          {/* GitLab Icon */}
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#fca326]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
          ...
          <li className='w-[160px] h-[60px] flex justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#6fc2b0]'>
            <a
              className='flex justify-between items-center w-full text-gray-300'
              href='https://gitlab.com/nbharrat'
            >
